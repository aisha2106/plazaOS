  ...
  return (
    <div>
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <input placeholder="Search announcements" value={query} onChange={(e) => setQuery(e.target.value)} className="min-h-[44px] w-full rounded-button border px-3 sm:w-auto" />
      </div>
      <Card>
        {isLoading ? (
