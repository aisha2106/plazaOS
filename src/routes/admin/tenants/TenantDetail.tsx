...
import { getTenant, updateTenant } from './data'
        ...
        {isResettingPassword ? (
          <div className="mt-4">
            <Text variant="bodySmall" className="text-slate-600">
              Password reset initiated. The tenant will be required to set a new password on next login. Once backend email delivery is connected, setup instructions will be sent to <span className="font-medium">{currentTenant.email}</span>.
            </Text>
          </div>
        ) : null}
      </Card>
