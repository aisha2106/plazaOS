...
// Admin-scoped select styled to match the shared Input component — the UI
// kit in src/components doesn't have one yet, so this stays local rather
// than adding a new shared component.
